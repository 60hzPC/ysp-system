  ...
  const handleCreateProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (projectImage) {
        ...
        formData.append('upload_preset', process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET || 'ysp-projects');
      ...
      setProjectForm({ name: '', description: '', chapter: '', status: 'open', image: '' });
        ...
        <form onSubmit={handleCreateProject} className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
              💡 Use free images from <a href="https://unsplash.com" target="_blank" rel="noopener noreferrer" className="text-yspOrange-500 hover:underline">Unsplash</a> or <a href="https://pexels.com" target="_blank" rel="noopener noreferrer" className="text-yspOrange-500 hover:underline">Pexels</a>. Right-click image → Copy image address
            </p>
            {projectForm.image && (
              <div className="mt-3">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80';
                  }}
                />
              </div>
            )}
